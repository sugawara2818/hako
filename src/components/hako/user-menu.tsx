...
import { MoreHorizontal, LogOut, UserMinus, User } from 'lucide-react'
      ...
      {isOpen && (
        <div className="absolute bottom-full left-0 mb-2 w-64 glass rounded-[24px] border border-white/10 bg-black/90 shadow-2xl overflow-hidden py-2 animate-in fade-in slide-in-from-bottom-2 duration-200 z-[100]">
          ...
          <form action={signOut}>
            <button
              type="submit"
              className="w-full flex items-center gap-3 px-4 py-3 text-sm text-gray-400 hover:text-white hover:bg-white/5 transition-colors text-left"
            >
